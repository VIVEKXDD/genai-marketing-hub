...
const posts = [
  {
    ...
    "company logo": "https://pbs.twimg.com/profile_images/1371391005891563527/rip-cwgt_bigger.jpg",
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    setTotalRetweets(posts.reduce((total, post) => total + (post.retweets || 0), 0));
    setTotalComments(posts.reduce((total, post) => total + (post.comments || 0), 0));
          ...
          <div className="flex flex-col items-start flex-grow">
            <div className="py-6">
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                <MetricCard title="Total Likes" value={totalLikes} change={40} />
                <MetricCard title="Total Retweets" value={totalRetweets} change={-10} />
                <MetricCard title="Total Comments" value={totalComments} change={20} />
                <MetricCard title="Total Views" value={totalViews} change={80} />
              </div>
